<template>
    <section id="footer-row" class="rGeu6w" data-scroll-ready="true" style="background-color: rgb(217, 217, 217);">
        <div>
            <div class="onhyOQ" style="width: 1792px; height: 549px; align-items: center;">
                <div class="twbtjQ">
                    <div class="GDnEHQ" style="width: 1792px; height: 549px; background-color: rgb(255, 255, 255);">
                        <div class="o2Yl2g">
                            <div class="_mXnjA" lang="en" style="width: 1792px; height: 549px;">
                                <div class="_6t4CHA">
                                    <div class="a26Xuw">
                                        <div class="fbzKiw" style="background: rgb(217, 217, 217);">
                                        </div>
                                    </div>
                                </div>
                                <div
                                ...
                                <div class="DF_utQ _682gpw _0xkaeQ"
                                    ...
                                    <div class="Zp7NQw">
                                        <div class="a26Xuw">
                                            <div class="PcHy7w">
                                                <div class="uk_25A Ty61NA">
                                                    <div class="Izwocg"
                                                        style="width: 66.6667px; height: 66.6667px; transform: translate(0px, 0px) rotate(0deg);">
                                                        <img class="dMHlHA" src="../_assets/media/logo.svg"
                                                            draggable="false">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            style="position: absolute; top: 0px; left: 0px; transform-origin: 0px 0px; height: 66.6667px; width: 66.6667px; pointer-events: none; transform: scale(1);">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    style="clip-path: polygon(213px 508.089px, 1579px 508.089px, 1579px 514.089px, 213px 514.089px);">
                                    <div class="DF_utQ _682gpw"
                                        style="touch-action: pan-x pan-y pinch-zoom; width: 1402.87px; height: 4px; transform: translate(194.567px, 509.089px) rotate(-0.0816839deg);">
                                        <div class="DF_utQ" style="width: 1402.87px; height: 4px;">
                                            <div class="V7MmMA"
                                                style="transform: scale(1); width: 1402.87px; height: 4px;">
                                                <svg class="Fe_H_Q" aria-hidden="true"
                                                    style="stroke: rgb(0, 45, 181); fill: rgb(0, 45, 181); width: 1402.87px; height: 4px;">
                                                    <path d="M0,2L1402.8650041356002,2" stroke-linecap="butt"
                                                        stroke-width="4" fill="none" pointer-events="auto" opacity="0"
                                                        class="_682gpw" style="touch-action: pan-x pan-y pinch-zoom;">
                                                    </path>
                                                    <g>
                                                        <path d="M0,2L1402.8650041356002,2" stroke-linecap="butt"
                                                            stroke-width="4" fill="none" pointer-events="none">
                                                        </path>
                                                    </g>
                                                </svg>
                                            </div>
                                ...
                                <div
                                    style="clip-path: polygon(213px 362.565px, 1579px 362.565px, 1579px 368.565px, 213px 368.565px);">
                                    <div class="DF_utQ _682gpw"
                                        style="touch-action: pan-x pan-y pinch-zoom; width: 1402.87px; height: 4px; transform: translate(194.567px, 363.565px) rotate(-0.0816839deg);">
                                        <div class="DF_utQ" style="width: 1402.87px; height: 4px;">
                                            <div class="V7MmMA"
                                                style="transform: scale(1); width: 1402.87px; height: 4px;">
                                                <svg class="Fe_H_Q" aria-hidden="true"
                                                    style="stroke: rgb(0, 45, 181); fill: rgb(0, 45, 181); width: 1402.87px; height: 4px;">
                                                    <path d="M0,2L1402.8650041356004,2" stroke-linecap="butt"
                                                        stroke-width="4" fill="none" pointer-events="auto" opacity="0"
                                                        class="_682gpw" style="touch-action: pan-x pan-y pinch-zoom;">
                                                    </path>
                                                    <g>
                                    ...
                                    <a class="social-link" href="https://www.instagram.com/crutchatta.ch/"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-521.3207 -530.673 1080 1080"
                                            ...
                                            <g id="object-1">
                                                ...
                                                <g transform="matrix(1.83, 0, 0, 1.83, 264.679291, -236.623001)">
                                                    <path
                                                        style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: round; stroke-miterlimit: 2; fill-rule: nonzero; opacity: 1;"
                                                        vector-effect="non-scaling-stroke"
                                                        transform=" translate(-386.4, -117.6)"
                                                        d="M 416.627 117.604 C 416.627 134.3 403.092 147.834 386.396 147.834 C 369.701 147.834 356.166 134.3 356.166 117.604 C 356.166 100.908 369.701 87.374 386.396 87.374 C 403.092 87.374 416.627 100.908 416.627 117.604 Z"
                                                        stroke-linecap="round" />
                                                </g>
                                            </g>
                                        </svg>
                                ...
                                <div class="DF_utQ _682gpw _0xkaeQ"
                                    style="touch-action: pan-x pan-y pinch-zoom; width: 481.14px; height: 97.3224px; transform: translate(289.8px, 206.003px);">
                                    <div
                                        style="width: 481.14px; height: 97.3224px; transform: scale(1, 1); transform-origin: 0px 0px;">
                                        <div class="DF_utQ _682gpw _0xkaeQ"
                                            style="touch-action: pan-x pan-y pinch-zoom; width: 481.133px; height: 44.2px; transform: translate(-8.52651e-14px, 3.55271e-14px);">
                                            <div class="aF9o6Q _0yZ6Qg"
                    ...
                    <div class="QhExXw pKfnlA" style="width: 1792px; height: 549px; margin: 0px;"></div>
                </div>
            </div>
        </div>
    </section>
